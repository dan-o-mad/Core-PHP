...
<th> Course Name </th>
<th> Q/A Marks (25) </th>
<th> Sessional Marks (15) </th>
<th> Mid Marks (25) </th>
<th> Final Marks (35) </th>
...
<td> <?php echo "{$row['course_qa']}"  ?> </td>
<td> <?php echo "{$row['course_sess']}"  ?> </td>
<td> <?php echo "{$row['course_mid']}"  ?> </td>
<td> <?php echo "{$row['course_final']}"  ?> </td>
<td> <?php echo "{$row['course_attendance']}"  ?> </td>
</tr>
